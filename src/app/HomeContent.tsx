                                ...
                                <div className="flex flex-wrap gap-x-8 gap-y-12">
                                    ...
                                    <div className="group relative inline-block">
                                        ...
                                        <motion.a
                                            ...
                                            whileHover={{ y: -4, x: -4 }}
                                            transition={{ type: "spring", stiffness: 300, damping: 20 }}
                                            className="relative inline-flex h-16 items-center justify-center border-4 border-foreground bg-background px-12 text-xl font-black uppercase text-foreground hover:bg-primary-foreground hover:bg-primary transition-colors"
                                        >
                                            WhatsApp
                                        </motion.a>
                                    </div>
