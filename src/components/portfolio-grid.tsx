    ...
    return (
        <div className="group relative">
            ...
            <Link href={`/projeto/${project.slug}`}>
                <motion.div
                    className="relative flex min-h-[400px] md:h-[500px] flex-col overflow-hidden border-4 border-foreground p-8 md:p-12 transition-all duration-300"
                    initial="initial"
                    whileHover="hover"
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute -right-4 -bottom-4 z-10 w-64 h-64 md:w-80 md:h-80 pointer-events-none opacity-0 group-hover:opacity-40 transition-opacity"
                    >
                        <Image
                            src={project.icon}
