            ...
            <Link href={`/projeto/${project.slug}`}>
                ...
                >
                    ...
                    <div className="relative z-20 flex justify-between items-start">
                        ...
                        <div className="w-14 h-14 border-4 border-foreground bg-background text-foreground flex items-center justify-center transition-all duration-300 hover:rotate-45 hover:bg-primary hover:text-primary-foreground cursor-pointer">
